...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	public void serchProduct() {
		Keyword.clickOn(searchBox);
		Keyword.sendKeys(productsTexts, "TV", Keys.ENTER);
	}

	public String getProductPrize() {
		String productName = Keyword.getText(TvName);
		return productName;
	...
	public String getProductName() {
		...
		String productPrize = Keyword.getText(TvPrize);
		return productPrize;

	}

	public void clickOnProduct() {
		waitsFor.visiblityOfElement(product);
		Keyword.clickOn(product);
	}
	...
	public String getPolicy() {
		String getPolicy = Keyword.getText(productPolicy);
		return getPolicy;
	}
	...
	public static ArrayList<String> productDetails() {
		...
		waitsFor.elementToBeClickableMethod(product);
		String productTitle = Keyword.getText(TvName);
		System.out.println(productTitle);
		String productRatings = Keyword.getText(productRating);
		String productPriz = Keyword.getText(TvPrize);
		productDetail.add(productTitle);
		productDetail.add(productRatings);
		productDetail.add(productPriz);
		return productDetail;

	}

	public static ArrayList<String> productDeatilsOnProductPage() {
		ArrayList<String> productDetailOnPage = new ArrayList<String>();
		String productPTitle = Keyword.getText(TvName);
		String productPRating = Keyword.getText(productRating);
		String productPPriz = Keyword.getText(TvPrize);
		productDetailOnPage.add(productPTitle);
		productDetailOnPage.add(productPRating);
		productDetailOnPage.add(productPPriz);
		return productDetailOnPage;
	}
